...
export const AddMeal = ({
  ...
  const removeRow = (e: any) => {
    if (rows.delete(e.target.value)) {
      ...
      console.error("Couldn't find Key at Add-Meals");
    }
  };
    ...
    <>
      ...
      <div className={styles.addMealCard}>
        ...
        >
          ...
          <button onClick={addRow} className={styles.mainButton}>
            Add Ingredient
          </button>
        </div>
        ...
        >
          <button onClick={submitMeal} className={styles.mainButton}>
            Submit
          </button>
          <button onClick={cancelMeal} className={styles.cancelMeal}>
            Cancel
          </button>
        </div>
      </div>
