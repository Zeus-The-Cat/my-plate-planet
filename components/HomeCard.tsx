  ...
  const Range = () => {
    return (
      <div className={styles.flexCentered}>
        <div>Range</div>
        <div className={styles.range} style={{ alignItems: "center" }}>
          <div>
            <div>From:</div>
  ...
  const Heading = () => {
    return (
      <div className={styles.HomeCardHeader}>
        ...
        {/* <Range></Range>  */}
        <button
          className={styles.homeCardAddMeal}
...
const LoggedOut = (props: any) => {
  ...
  return (
    <div
      ...
      style={{ background: "var(--green-lightest)", borderRadius: 15 }}
    >
      <Heading></Heading>
      <Entries
        history={props.history}
        setHistory={props.setHistory}
        addingMeal={addingMeal2}
        setAddingMeal={setAddingMeal2}
      ></Entries>
    </div>
  );
};
...
const HomeCard = () => {
  ...
  return (
    <div className={styles.HomeCard}>
      {userContext?.auth.currentUser ? (
        <LoggedIn history={history} setHistory={setHistory}></LoggedIn>
      ) : (
        <LoggedOut history={history} setHistory={setHistory}></LoggedOut>
      )}
    </div>
  );
};
