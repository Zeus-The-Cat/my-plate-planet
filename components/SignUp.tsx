      ...
      <form>
        <label htmlFor="Email-Login">
          ...
          <input
            ...
            title="testing"
          />
          <div className={styles.message}>{emailError}</div>
          Password
          <br />
          <input
            type="password"
          ...
          />
          <div className={styles.message}>{passwordError}</div>
          Re-Enter Password
          <br />
          <input
            type="password"
          ...
          />
          <div className={styles.message}>{passwordMatchError}</div>
          <br />
        </label>
      </form>

      <button name="email-password-submit" onClick={submitUser}>
        Create Account
      </button>
    </div>
  );
